...
*Limitations*: 
- Ecozones are **proxy** measures of ecologically relevent protected areas
- PHEI does not account for protected areas where ecozones intersect
- Sensitivity: 

*Strengths*: 
- Measurable and built from peer-reviewed method to assess inequality across units
- High quality data, updated often
- Simple to communicate, and provides immediate feedback to decision-makers
