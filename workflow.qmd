...
**Limitations**: <br>
- Ecozones are **proxy** measures of ecologically relevent protected areas<br>
- PHEI does not account for protected areas where ecozones intersect<br>

**Strengths**: <br>
- Measurable and built from peer-reviewed method to assess inequality across units <br>
- High quality data, updated often<br>
- Simple to communicate, provides immediate feedback to decision-makers<br>
